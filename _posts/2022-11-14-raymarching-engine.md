...
In the winter of 2021, I worked upon a Raymarching Engine for Unity to help me render volumetric clouds efficiently. It currently supports over 30 primtives (sphere, cube, capped cone, etc.) and 3 operations (Union, Intersection, Subtraction) and can be downloaded [here](https://github.com/aniketrajnish/Raymarching-Engine-Unity).

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <video class="video-fluid rounded z-depth-1" autoplay muted loop>
            <source src="../../../assets/img/RM_Engine.mp4" type="video/mp4">
        </video>
    </div>
</div>
