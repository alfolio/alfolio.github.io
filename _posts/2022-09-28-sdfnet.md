...
We stopped updating blogs for past couple of months, but we'll update them soon. Meanwhile you can find the work done in the first half of the project can be found [here](https://makra.wtf/assets/pdf/SDFNet_Poster.pdf).
